...
namespace Neuron
{
    ...
    public class NeuronActor
    {
        ...
        public Vector3 GetReceivedRotation(NeuronBones bone, bool proxm)
        {
            int offset = 0;
            if (header.bWithReference != 0)
            {
            ...
            if (proxm)
            {
                ...
                //     case 44:
                //         return new Vector3(0.0f, 0.0f, Mathf.Clamp(-data[offset + 2], 0.0f, 25.0f));
                //     case 48:
                //         return new Vector3(0.0f, -1.0f, Mathf.Clamp(-data[offset + 2], 0.0f, 25.0f));
                //     case 52:
                //         return new Vector3(0.0f, -1.0f, Mathf.Clamp(-data[offset + 2], 0.0f, 25.0f));
                //     case 56:
                //         return new Vector3(0.0f, -15.0f, Mathf.Clamp(-data[offset + 2], 0.0f, 15.0f));
                //     default:
                ...
                switch ((int)bone)
                {
                    ...
                    //     return new Vector3(0.0f, Mathf.Clamp(180.0f - data[offset], 180.0f - 30.0f, 180.0f + 30.0f), 100.0f);
                    case 40:
                        return new Vector3(1f, Mathf.Clamp(0f, -data[offset] - 55, 15f), 5f);
                    case 44:
                        return new Vector3(0.0f, 0.0f, Mathf.Clamp(-data[offset + 2], 0.0f, 56.0f));
                    case 48:
                        return new Vector3(0.0f, -1.0f, -data[offset + 2]);
                    case 52:
                        return new Vector3(0.0f, -1.0f, -data[offset + 2]);
                    case 56:
                        return new Vector3(0.0f, -5.0f, -data[offset + 2]);
                    default:
                        return new Vector3(0, 0, 0);
            ...
            else
            {
                ...
                {
                    case 38:
                        return new Vector3(0.0f, -90 + (-data[offset]), 0.0f);
                    case 45:
                        return new Vector3(0.0f, 0.0f, Mathf.Clamp(-data[offset + 2], 0.0f, 15.0f));
                    case 49:
                        return new Vector3(0.0f, 0.0f, Mathf.Clamp(-data[offset + 2], 0.0f, 15.0f));
                    case 53:
                        return new Vector3(0.0f, 0.0f, Mathf.Clamp(-data[offset + 2], 0.0f, 15.0f));
