...
/// <summary>
/// Animator for the second arm (two arms scene)
/// </summary>
public class AnimatorTwo : MonoBehaviour
{
    ...
    void Update()
    {
        try
        {
            var data = DataTransfer.queue2.Dequeue();
    ...
    public Vector3 GetReceivedRotation(int bone, float[] data, bool proxm)
    {
        ...
        // {
        //     case 0:
        //         return new Vector3(Mathf.Clamp(data[offset + 1], -40.0f, -30.0f), Mathf.Clamp(-data[offset], -30.0f, 30.0f), Mathf.Clamp(-data[offset + 2], -30.0f, 0.0f));
    ...
    public static void ApplyMotion(AnimatorTwo actor, Animator animator, float[] data)
    {
